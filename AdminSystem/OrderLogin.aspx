...
<body>
    <form id="OrderLogin" runat="server">
        <div>
            ...
            <asp:Button ID="btnLogin" runat="server" style="z-index: 1; left: 65px; top: 182px; position: absolute; height: 22px; width: 62px;" Text="Login" OnClick="btnLogin_Click" />
            <asp:Button ID="btnMainMenu" runat="server" style="z-index: 1; left: 65px; top: 217px; position: absolute; height: 22px; width: 151px;" Text="Return to Main Menu" OnClick="btnMainMenu_Click" />
