...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Find" runat="server" Height="28px" Text="Find" Width="72px" />
        </div>
        <p>
            &nbsp;</p>
        ...
        <asp:Label ID="lblNameId" runat="server" style="z-index: 1; left: 16px; top: 85px; position: absolute" Text="Name"></asp:Label>
        <asp:Label ID="lblEmailId" runat="server" style="z-index: 1; left: 16px; top: 124px; position: absolute" Text="Email"></asp:Label>
        <asp:Label ID="lblPhoneNumberId" runat="server" style="z-index: 1; left: 16px; top: 160px; position: absolute" Text="PhoneNumber"></asp:Label>
        <asp:Label ID="lblIsSubscribedId" runat="server" style="z-index: 1; left: 16px; top: 200px; position: absolute" Text="IsSubscribed"></asp:Label>
        <asp:Label ID="lblAddress" runat="server" style="z-index: 1; left: 16px; position: absolute; top: 238px" Text="Address"></asp:Label>
        <asp:Label ID="lblCreatedAtId" runat="server" style="z-index: 1; left: 16px; top: 267px; position: absolute" Text="CreatedAt"></asp:Label>
        ...
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 53px; top: 398px; position: absolute; width: 58px; height: 24px;" Text="OK" />
