...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-left: 720px">
            <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 60px; top: 308px; position: absolute; right: 2014px; width: 60px;" Text="OK" height="25px" />
        </div>
        <p>
            &nbsp;</p>
